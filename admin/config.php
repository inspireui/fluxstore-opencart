...
// HTTP
define('HTTP_SERVER', WEBSITE_URL.'/admin/');
define('HTTP_CATALOG', WEBSITE_URL);

// HTTPS
define('HTTPS_SERVER', WEBSITE_URL.'admin/');
define('HTTPS_CATALOG', WEBSITE_URL);

// DIR
define('DIR_APPLICATION', WEBSITE_DIRECTORY.'admin/');
...
define('DIR_CATALOG', WEBSITE_DIRECTORY.'catalog/');
